...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			cashierlog.Table:     cashierlog.ValidColumn,
			sale.Table:           sale.ValidColumn,
			saleitem.Table:       saleitem.ValidColumn,
			salereturn.Table:     salereturn.ValidColumn,
			salereturnitem.Table: salereturnitem.ValidColumn,
